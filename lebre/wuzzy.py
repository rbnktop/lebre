...
class Core():
    ...
    def process_sheet(self, raw_df):
        ...
        >becomes: 5 fralda pampers com 12 unidades
    ...
    def sec_fuz(self, candidates):
        ...
        try:
            ...
            for c in best_candidates:
                if c[0].candidate_name == 'none':
                    analytics +=1

            n_targets = len(targets)
            return results, analytics, n_targets
